...
from atnBangla.views import newssite, atn_about,livetvhomwlist,atn_youtube_playlist,fblink,polls_detail,apps_coverimgview,short_playlist,livetvlisst,livetvdlts
urlpatterns = [
