...
from atnBangla.views import newssite, atn_about,ad_code,livetvhomwlist,atn_youtube_playlist,fblink,polls_detail,apps_coverimgview,short_playlist,livetvlisst,livetvdlts
urlpatterns = [
    ...
    path('fb', fblink),
    path('weblist_home', livetvhomwlist.as_view()),
    path('news', newssite),
